...
export default function App({ }) {
  ...
  useEffect(() => {
    ...
    console.log("REMOTERTCDATA ", remoteRTCMessage.current);
    console.log("OTHERUSERIDDATA", otherUserId.current);
    console.log("///////////////////////////////");
    ...
    console.log("REMOTERTCMESSAGE", remoteRTCMessage.current);
    console.log("///////////////////////////////");
    ...
    mediaDevices.enumerateDevices().then((sourceInfos) => {
      ...
      mediaStream = mediaDevices
        ...
        .then((stream) => {
          ...
          console.log("LOCALSTREAN", localStream);
          if (peerConnection.current) {
            ...
            console.error(
              "peerConnection.current não está definido."
            );
          }
        })
        .catch((error) => {
          console.log("DEU ERRO AO RESULTADO DA PROMISE", error);
        });
    });

    peerConnection.current.ontrack = (event) => {
      setRemoteStream(event.streams[0]); // event.streams é uma lista de streams
    };
    console.log("REMOTESTREAM APÓS ONADDSTREAM", remoteStream);
    console.log("///////////////////////////////////");

    peerConnection.current.onicecandidate = (event) => {
      console.log("EVENT CANDIDATE OK", event.candidate);
      if (event.candidate) {
        sendICEcandidate({
